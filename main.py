...
functions.monte_carlo("call", S0, 115, 1, 30, deltat, drift_bulanan, volatility_bulanan, sukubunga_bulanan)
functions.monte_carlo("call", S0, 180, 1, 30, deltat, drift_bulanan, volatility_bulanan, sukubunga_bulanan)
functions.monte_carlo("put", S0, 150, 1, 30, deltat, drift_bulanan, volatility_bulanan, sukubunga_bulanan)
functions.monte_carlo("put", S0, 185, 1, 30, deltat, drift_bulanan, volatility_bulanan, sukubunga_bulanan)
